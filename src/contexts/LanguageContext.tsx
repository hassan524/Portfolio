...
export const translations = {
  en: {
    ...
    hero: {
      ...
      title1: "Hey, I'm",
      subtitle: "Full-stack developer who loves building things — APIs, UIs, and everything in between. Also diving into cybersecurity and Linux kernel dev.",
      cta1: "See My Work",
      cta2: "Contact Me",
    ...
    about: {
      ...
      p2: "I work daily with AI tools like Claude AI, GitHub Copilot, OpenAI Codex, and Cursor to accelerate development and ship better code faster. I'm also deeply interested in cybersecurity fundamentals, Linux kernel internals, and systems-level programming.",
      ...
      interests: ["🛡️ Cybersecurity", "🐧 Linux Kernel", "🤖 AI / LLMs", "☁️ Cloud / DevOps"],
    },
  ...
  ur: {
    ...
    hero: {
      ...
      lookingLabel: "تلاش ←",
      title1: "ہیلو، میں ہوں",
      subtitle: "ٹیکنالوجی کا دلدادہ فل اسٹیک ڈویلپر — جدید ویب ایپس، AI ٹولز، سائبر سیکیورٹی اور لینکس میں گہری دلچسپی۔",
    ...
    about: {
      ...
      p2: "میں Claude AI، Codex، Cursor جیسے AI ٹولز روزانہ استعمال کرتا ہوں۔ سائبر سیکیورٹی اور لینکس کرنل میں بھی گہری دلچسپی ہے۔",
      ...
      interests: ["🛡️ سائبر سیکیورٹی", "🐧 لینکس کرنل", "🤖 AI / LLMs", "☁️ کلاؤڈ / DevOps"],
    },
  ...
  es: {
    ...
    hero: {
      ...
      title1: "Hola, soy",
      subtitle: "Desarrollador full-stack apasionado por la tecnología — UIs modernas, APIs robustas, IA, ciberseguridad y Linux.",
      cta1: "Ver mi trabajo",
      cta2: "Contáctame",
    ...
    about: {
      ...
      p2: "Uso Claude AI, Codex y Cursor a diario. También tengo un gran interés en ciberseguridad y el kernel de Linux.",
      ...
      interests: ["🛡️ Ciberseguridad", "🐧 Kernel de Linux", "🤖 IA / LLMs", "☁️ Cloud / DevOps"],
    },
  ...
  fr: {
    ...
    hero: {
      ...
      subtitle: "Développeur full-stack passionné de technologie — UI modernes, APIs robustes, IA, cybersécurité et Linux.",
    ...
    about: {
      ...
      p2: "J'utilise Claude AI, Codex et Cursor quotidiennement. Je m'intéresse aussi à la cybersécurité et au noyau Linux.",
      ...
      interests: ["🛡️ Cybersécurité", "🐧 Noyau Linux", "🤖 IA / LLMs", "☁️ Cloud / DevOps"],
    },
