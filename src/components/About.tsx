        ...
        >
            ...
            <div className="container mx-auto flex flex-col md:flex-row items-start gap-12">
                ...
                <div className="w-full md:w-1/2 text-center md:text-left flex md:items-start items-center flex-col gap-6">
                    ...
                    <button className="bg-slate-900 cursor-pointer border border-transparent hover:border-slate-900 transition duration-300 hover:text-slate-900 hover:bg-transparent text-white px-4 py-2 rounded-lg tracking-wide" data-aos="fade-down"  data-aos-duration={1000}>
                        Dowmload Resume
                    </button>
                </div>
